...
if (strlen($_SESSION['detsuid'] == 0)) {
    ...
    $query = "SELECT ExpenseDate, SUM(ExpenseCost) as TotalExpense 
              FROM tblexpense 
              WHERE UserId='$uid' AND ExpenseDate >= DATE(NOW()) - INTERVAL 7 DAY 
...
<head>
    ...
    <title>Daily Expense Tracker || Weekly Expense Report</title>
    ...
    <div class="col-sm-9 col-sm-offset-3 col-lg-10 col-lg-offset-2 main">
        <div class="row">
            <ol class="breadcrumb">
                ...
                <li class="active">Weekly Expense Report</li>
            </ol>
        </div><!--/.row-->
        ...
        <div class="row">
            <div class="col-lg-12">
                <div class="panel panel-default">
                    <div class="panel-heading">Weekly Expense Report</div>
