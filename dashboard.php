...
$sum_weekly_expense=$result2['weeklyexpense'];
 ?>
					<div class="panel-body easypiechart-panel"><a href="weekly-expense-report.php">
						<h4>Last 7day's Expense</h4></a>
...
$sum_monthly_expense=$result3['monthlyexpense'];
 ?>
					<div class="panel-body easypiechart-panel"><a href="last-30-days-graph.php">
						<h4>Last 30day's Expenses</h4></a>
...
$sum_yearly_expense=$result4['yearlyexpense'];
 ?>
					<div class="panel-body easypiechart-panel"><a href="year-graph.php">
						<h4>Current Year Expenses</h4></a>
...
$sum_total_expense=$result5['totalexpense'];
 ?>
					<div class="panel-body easypiechart-panel"><a href="total-graph.php">
						<h4>Total Expenses</h4></a>
